...
|---|---|---|
| CN701 pin 5 | RDS-C | Recovered RDS clock presented to the Sony controller |
| CN702 pin 6 | RDS-D | Recovered RDS data presented to the Sony controller |
...
- Bit order: MSB first
- Data remains stable across the observed clock transitions
...
3. Start with the built-in `RADIO538` profile.
4. Enable the buffer only after verifying clock and data at the buffer input.
5. Confirm that the Sony controller reconstructs `RADIO538` and `Radio 538`.
